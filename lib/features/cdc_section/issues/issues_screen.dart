...
class CdcSectionIssuesScreenView extends StatefulWidget {
  const CdcSectionIssuesScreenView({super.key});

  @override
  State<CdcSectionIssuesScreenView> createState() =>
      _CdcSectionIssuesScreenViewState();
}

class _CdcSectionIssuesScreenViewState
    extends State<CdcSectionIssuesScreenView> {
            ...
            child: ListView(
              ...
              children: [
                ...
                const _IssueListCard(
                  ...
                  submittedBy: 'Agriculture and Agro..',
                  description:
                      'ផ្នែកឯកជនបានលើកឡើងថា ទំនិញទាំងពីរប្រភេទនេះ មិនមានឈ្មោះក្នុងកាតាឡុកយន្តការ នឹងសេរីកសិកម្មនៅឡើយ ដោយការចេញវគ្គនៃបណ្ណសេរីរូបនីយកម្មកសិកម្ម ផ្អែកលើការលក់ដាត នៅក្នុង...',
                  attachmentCount: '2 Attachement',
                ),
                const _IssueListCard(
                  title: 'Issue for local aquaculture...',
                  category: 'Governance',
                  status: 'Solved',
                  submissionDate: 'July 24, 2025',
                  submittedBy: 'Agriculture and Agro..',
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        isSolved ? l10n.text('solved') : l10n.text('inProgress'),
                        style: TextStyle(
                          color: statusColor,
                          fontSize: 11,
                          fontWeight: FontWeight.w700,
